...
reference. The comparable D-FINE-M summary remains in `docs/BENCHMARKS.md`; the full matrices are
preserved in [this release's validation record](https://github.com/PogChamper/dfine-cpp/blob/v0.3.3/docs/VALIDATION.md#full-methodology-results-maintainer-run). The tier ladder and the lossless
