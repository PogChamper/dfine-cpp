    ...
    metadata = {
        ...
        **ra.MODEL_FACTS[size],
        ...
        "model_source": {
            ...
            "dirty": False,
            "matches_validated_revision": True,
        },
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (lambda meta: meta["model_source"].update(dirty=True), "model_source"),
        (
            lambda meta: meta["model_source"].update(commit="d" * 40),
            "model_source",
        ),
